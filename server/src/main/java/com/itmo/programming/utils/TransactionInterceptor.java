...
public class TransactionInterceptor {
    ...
    // допустим findById -> какой то другой метод сервиса -> метод сервиса в котором происходит ошибка
    // rollback нужно делать на первом методе, потому что транзакция была открыта только там
